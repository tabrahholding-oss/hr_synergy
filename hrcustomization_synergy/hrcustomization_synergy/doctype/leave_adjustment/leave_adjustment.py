...
@frappe.whitelist()
def get_total_leave(employee, leave_type):
	"""
	Returns total leave balance for an employee
	"""
	...
	return flt(leave_balance[0].total_leaves) if leave_balance and leave_balance[0].total_leaves else 0